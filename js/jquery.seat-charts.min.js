	...
	e.fn.seatCharts = function(t) {
		...
		u = function(t, n) {
			return function(i) {
				...
				s.node().on("click", s.click).on("mouseenter", s.focus).on("mouseleave", s.blur).on("keydown",
				function(e, n) {
					return function(i) {
						var s;
						switch (i.which) {
		...
		o.naming.columns = o.naming.columns ||
		function(e) {
			var t = [];
			for (var n = 1; n <= e; n++) {
				t.push(n)
		...
		function(t, s) {
			...
			e.each(s.match(/[a-z_]{1}(\[[0-9a-z_]{0,}(,[0-9a-z_ ]+)?\])?/gi),
			function(n, s) {
		...
		n.data("seatCharts", {
			...
			set: function f() {
				...
				return {
					...
					push: function(e, t) {
						this.seats.push(t);
						this.seatIds.push(e); ++this.length
					}
				}
			},
			get: function(t) {
